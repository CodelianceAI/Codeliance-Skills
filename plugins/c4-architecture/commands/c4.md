...
**Source traceability:** Components include `source` properties linking to the code they represent. A validation script checks that local source paths still exist:
